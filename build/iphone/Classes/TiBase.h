...
// in simulator we redefine to format for Fisl Developer console
...
{\
	NSString * exceptionName = [@"org.fisl." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fisl";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIFislNativeItemNone = -1, 
	UIFislNativeItemSpinner = -2,
	UIFislNativeItemProgressBar = -3,
	
	UIFislNativeItemSlider = -4,
	UIFislNativeItemSwitch = -5,
	UIFislNativeItemMultiButton = -6,
	UIFislNativeItemSegmented = -7,
	
	UIFislNativeItemTextView = -8,
	UIFislNativeItemTextField = -9,
	UIFislNativeItemSearchBar = -10,
	
	UIFislNativeItemPicker = -11,
	UIFislNativeItemDatePicker = -12,
	
	UIFislNativeItemInfoLight = -13,
	UIFislNativeItemInfoDark = -14,
	
	UIFislNativeItemDisclosure = -15,
	
	UIFislNativeItemContactAdd = -16
};
